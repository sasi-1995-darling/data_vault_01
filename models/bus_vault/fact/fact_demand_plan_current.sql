---- SRC LAYER ----
WITH
SRC_dc             as ( SELECT ANALYST_LIFT, APO_ACCOUNT, APO_ORDER_QUANTITY_HISTORY, ACQUISITION_DATE__YYYYMMDD, CUSTOMER_QTY_ON_HAND, DEMAND_PLAN_LHK, DISTRIBUTION_CHANNEL_BK, DISTRIBUTION_CHANNEL_HK, DIVISION_BK, DIVISION_HK, Distribution_Channel, FINAL_FORECAST, FORECAST_CUSTOMER_GROUP_BK, FORECAST_CUSTOMER_GROUP_HK, Fiscal_Period, Fiscal_Quarter, Fiscal_Variant, ITEM_BK, ITEM_HK, MANUALLY_CORRECTED_HISTORY, MOEN_PROP_FACTOR, NAIVE_FORECAST, NEW_PRODUCT_FORECAST, OUTED_DEMAND, PLANNING_PERIOD, PLANT_BK, PLANT_HK, PROMOTIONS_QTY, PSA_DELETE_IND, QUANTITY_SOLD_CUSTOMER_POS, SALES_ORGANIZATION_BK, SALES_ORGANIZATION_HK, SEQ_ID, STATISTICAL_FORECAST_T1, Sales_Org, TRANSFERABLE_DEMAND, TRANSFERABLE_FORECAST, UOM_BK, UOM_HK, WORKING_FORECAST, cal_month, cal_quarter, cal_week, cal_year, division, material, order_qty, plant, REC_SRC, BKCC FROM {{ ref('pb_demand_plan_current') }} as SRC  )

/*
SRC_dc             as ( SELECT * FROM BUS_VAULT.pb_demand_plan_current )
*/
---- LOGIC LAYER ----

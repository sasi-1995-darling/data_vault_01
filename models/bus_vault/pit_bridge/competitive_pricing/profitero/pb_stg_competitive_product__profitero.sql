...
SRC_S              as ( SELECT RANKING_PRODUCT_ID, RPC, EAN, UPC, MODEL, URL, REC_SRC, COMPETITIVE_PRODUCT_HK, RETAILER_HK FROM {{ ref('sat_competitive_products__profitero') }} as SRC 
...
SRC_S              as ( SELECT * FROM raw_vault.SAT_COMPETITIVE_PRODUCTS__PROFITERO )
*/
---- LOGIC LAYER ----

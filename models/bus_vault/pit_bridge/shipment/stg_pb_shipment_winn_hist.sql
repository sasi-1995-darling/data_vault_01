...
with cte_lsat_copa_sales_history as (
    select
        lnk_copa_sales_hk
        , budat_dt
        , vtweg
        ...
        , auart
        , load_dts
    from {{ ref('lsat_copa_sales_history__winn_sap') }}
    where budat_dt >= '2019-01-01' 
...
, base as ( 
    select cte_join_base.*
        ...
        , lsatcopa.auart
     from cte_join_base 
        inner join cte_lsat_copa_sales_history as lsatcopa

...
, msat_payment_term_text_emtk as (
    select
        payment_term_hk,
        term_id,
        language,
...
, sat_supplier_site_emtk as (
    select
        ...
        _fivetran_deleted
    from {{ ref('sat_supplier_site__emtk_ebs') }}
...
select
    ...
    , msat_payment_term_text_emtk.term_id::text                                                                    as payment_term_code
    , msat_payment_term_text_emtk.name                                                                       as payment_term_desc
    , msat_payment_term_lines_emtk.due_days::integer                                                         as due_days
    , msat_payment_term_lines_emtk.due_months_forward::integer                                               as due_months_forward
    , coalesce(msat_payment_term_lines_emtk.due_days, msat_payment_term_lines_emtk.due_months_forward * 30)    as payment_term_due_days
    , coalesce(msat_payment_term_lines_emtk.discount_days, 
             coalesce(msat_payment_term_lines_emtk.discount_months_forward, msat_payment_term_lines_emtk.discount_months_forward_2, msat_payment_term_lines_emtk.discount_months_forward_3, 0) * 30) 
                                                                                                            as discount_days
    , coalesce(msat_payment_term_lines_emtk.discount_percent, msat_payment_term_lines_emtk.discount_percent_2, msat_payment_term_lines_emtk.discount_percent_3, 0)
                                                                                                            as discount_percent
    , sat_supplier_site_emtk.payment_currency_code   as currency_code
    , IFF(sat_supplier_site_emtk._FIVETRAN_DELETED = 'TRUE', 'Y', 'N')                                   as is_deleted
...
from lnk_supplier_site_payment_term
    ...
    left join msat_payment_term_text_emtk
        on msat_payment_term_text_emtk.payment_term_hk = lnk_supplier_site_payment_term.payment_term_hk
        and msat_payment_term_text_emtk.language = 'US'
    left join msat_payment_term_lines_emtk
        on msat_payment_term_lines_emtk.payment_term_hk = lnk_supplier_site_payment_term.payment_term_hk
    left join sat_supplier_site_emtk
        on sat_supplier_site_emtk.supplier_site_hk = lnk_supplier_site_payment_term.supplier_site_hk
where bkcc = 'Diving_Sea'

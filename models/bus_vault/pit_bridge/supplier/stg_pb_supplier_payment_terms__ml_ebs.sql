...
, sat_supplier_site_ml as (
    select
        ...
        _fivetran_deleted
    from {{ ref('sat_supplier_site__ml_ebs') }}
...
select
    ...
    , lnk_supplier_site_payment_term.lnk_supplier_site_payment_term_hk
    ...
    , msat_payment_term_text_ml.term_id::text                                                                    as payment_term_code
    , msat_payment_term_text_ml.name                                                                       as payment_term_desc
    , msat_payment_term_lines_ml.due_days::integer                                                         as due_days
    , msat_payment_term_lines_ml.due_months_forward::integer                                               as due_months_forward
    , coalesce(msat_payment_term_lines_ml.due_days, msat_payment_term_lines_ml.due_months_forward * 30)    as payment_term_due_days
    , coalesce(msat_payment_term_lines_ml.discount_days, 
             coalesce(msat_payment_term_lines_ml.discount_months_forward, msat_payment_term_lines_ml.discount_months_forward_2, msat_payment_term_lines_ml.discount_months_forward_3, 0) * 30) 
                                                                                                            as discount_days
    , coalesce(msat_payment_term_lines_ml.discount_percent, msat_payment_term_lines_ml.discount_percent_2, msat_payment_term_lines_ml.discount_percent_3, 0)
                                                                                                            as discount_percent
    , sat_supplier_site_ml.payment_currency_code   as currency_code
    , IFF(sat_supplier_site_ml._FIVETRAN_DELETED = 'TRUE', 'Y', 'N')                                   as is_deleted
...
from lnk_supplier_site_payment_term
    ...
    left join msat_payment_term_text_ml
        on msat_payment_term_text_ml.payment_term_hk = lnk_supplier_site_payment_term.payment_term_hk
        and msat_payment_term_text_ml.language = 'US'
    left join msat_payment_term_lines_ml
        on msat_payment_term_lines_ml.payment_term_hk = lnk_supplier_site_payment_term.payment_term_hk
    left join sat_supplier_site_ml
        on sat_supplier_site_ml.supplier_site_hk = lnk_supplier_site_payment_term.supplier_site_hk
where  bkcc = 'Crouching_Dragon'

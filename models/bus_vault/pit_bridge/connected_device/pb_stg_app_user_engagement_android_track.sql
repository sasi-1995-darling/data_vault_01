...
SRC_STA            as ( SELECT ANONYMOUS_ID, CONSUMER_HK, CONTEXT_APP_NAME, CONTEXT_OS_NAME, CONTEXT_TRAITS_ANONYMOUS_ID, EVENT, EVENT_TEXT, TIMESTAMP FROM {{ ref('sat_user_engagement_track__android_moen') }} as SRC 

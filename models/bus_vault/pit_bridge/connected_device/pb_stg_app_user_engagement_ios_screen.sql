...
SRC_SSI            as ( SELECT ANONYMOUS_ID, CONSUMER_HK, CONTEXT_APP_NAME, CONTEXT_OS_NAME, CONTEXT_TRAITS_ANONYMOUS_ID, NAME, TIMESTAMP FROM {{ ref('sat_user_engagement_screen__ios_moen') }} as SRC 
...
SRC_SSI            as ( SELECT * FROM raw_vault.SAT_USER_ENGAGEMENT_SCREEN__IOS_MOEN )
*/
---- LOGIC LAYER ----

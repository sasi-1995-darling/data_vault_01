...
SRC_STI            as ( SELECT ANONYMOUS_ID, CONSUMER_HK, CONTEXT_APP_NAME, CONTEXT_OS_NAME, CONTEXT_TRAITS_ANONYMOUS_ID, EVENT, EVENT_TEXT, REC_SRC, TIMESTAMP FROM {{ ref('sat_user_engagement_track__ios_flo') }} as SRC 
...
SRC_STI            as ( SELECT * FROM raw_vault.SAT_USER_ENGAGEMENT_TRACK__IOS_FLO )

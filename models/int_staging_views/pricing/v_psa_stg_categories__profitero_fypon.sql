---- SRC LAYER ----
WITH
SRC_S              as ( SELECT * FROM {{ source('profitero_fypon', 'categories_products') }} as SRC 
...
/*
SRC_S              as ( SELECT * FROM profitero_fypon.categories_products )
...
, FILTER_a as (
    SELECT *
    FROM RENAME_a
    WHERE rec_src = 'US.PROFITERO_FYPON.CATEGORIES_PRODUCTS'
)

---- SRC LAYER ----
WITH
SRC_S              as ( SELECT * FROM {{ source('profitero_security', 'categories_products') }} as SRC 
...
/*
SRC_S              as ( SELECT * FROM profitero_security.categories_products )
...
, FILTER_a as (
    SELECT *
    FROM RENAME_a
    WHERE rec_src = 'US.PROFITERO_SECURITY.CATEGORIES_PRODUCTS'
)

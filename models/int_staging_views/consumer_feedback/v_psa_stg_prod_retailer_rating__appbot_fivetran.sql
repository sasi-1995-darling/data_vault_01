---- SRC LAYER ----
WITH
SRC_S1             as ( SELECT APP_ID, AVG, COUNTRY, COUNTRY_CODE, COUNTRY_ID, CREATED_AT, PSA_DELETE_IND, PSA_LOAD_DTS, PSA_RECORD_SOURCE, STAR_1, STAR_2, STAR_3, STAR_4, STAR_5, TOTAL, VERSION, _FIVETRAN_SYNCED FROM {{ source('custom_fivetran_appbot_sdk', 'ratings') }} as SRC 
...
/*
SRC_S1             as ( SELECT * FROM custom_fivetran_appbot_sdk.ratings )

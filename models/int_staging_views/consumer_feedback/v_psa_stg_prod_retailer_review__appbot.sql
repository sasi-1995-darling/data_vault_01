...
/*
SRC_S1             as ( SELECT * FROM appbot_psa.reviews )
...
, FILTER_A1 as (
    SELECT *
    FROM RENAME_A1
    WHERE rec_src = 'US.APPBOT.REVIEWS'
)
...
SELECT
        ...
        , SUBJECT
        , PUBLISHED_AT
        , TRY_TO_TIMESTAMP_TZ(PUBLISHED_AT_DATETIME) AS PUBLISHED_AT_DATETIME
        , VERSION
        , COUNTRY
        , COUNTRY_ID
        , COUNTRY_CODE

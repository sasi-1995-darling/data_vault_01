---- SRC LAYER ----
WITH
SRC_S1             as ( SELECT DIM_RETAILER_LOCATION_KEY, PSA_DELETE_IND, PSA_LOAD_DTS, PSA_RECORD_SOURCE, RETAILER_LOCATION_ALIAS, RETAILER_LOCATION_NAME, UPDATED_AT
...
/*
SRC_S1             as ( SELECT * FROM profitero_share_larson.dim_retailer_location )
...
, FILTER_A1 as (
    SELECT *
    FROM RENAME_A1
    WHERE rec_src = 'US.PROFITERO_THERMATRU.RETAILERS'
)

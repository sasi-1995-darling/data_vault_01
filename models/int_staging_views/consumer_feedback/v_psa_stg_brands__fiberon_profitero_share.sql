...
SRC_S1             as ( SELECT BRAND, BRAND_NAME, BRAND_OWNER, DIM_BRAND_KEY, FULL_NAME, PSA_DELETE_IND, PSA_LOAD_DTS, PSA_RECORD_SOURCE, SUBBRAND, SUBSUBBRAND, UPDATED_AT
                        ...
                        FROM {{ source('profitero_share_fiberon', 'dim_brand') }} as SRC
...
/*
SRC_S1             as ( SELECT * FROM profitero_share_fiberon.dim_brand )
SRC_C1             as ( SELECT * FROM profitero_share_fiberon.dim_account_product )

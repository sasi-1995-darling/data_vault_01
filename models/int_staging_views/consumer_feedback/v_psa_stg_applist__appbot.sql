---- SRC LAYER ----
WITH
SRC_S1             as ( SELECT AUTHENTICATED, ICON, ID, IDENTIFIER, NAME, PSA_DELETE_IND, PSA_LOAD_DTS, PSA_RECORD_SOURCE, STORE, STORE_ID, TRANSLATION_SUPPORTED FROM {{ source('appbot_psa', 'applist') }} as SRC  ),

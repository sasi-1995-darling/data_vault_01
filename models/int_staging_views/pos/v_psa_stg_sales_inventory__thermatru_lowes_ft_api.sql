...
SRC_S              as ( SELECT AVAILABLE_DC_INVENTORY_UNITS, AVAILABLE_RETAIL_INVENTORY_UNITS, AVERAGE_YEAR_TO_DATE_SALES, END_DATE, GROSS_ITEM_QUANTITY, 
                        ...
                        YEAR_TO_DATE_WEEKLY_AVERAGE_SALES, _FIVETRAN_DELETED, _FIVETRAN_SYNCED FROM {{ source('custom_fivetran_lowes_vpp_sales_inventory', 'sales_inventory_thermatru') }} as SRC  ),
SRC_A              as ( SELECT BKCC, REC_SRC FROM {{ ref('ref_business_key_collision') }} as SRC  )

/*
SRC_S              as ( SELECT * FROM custom_fivetran_lowes_vpp_sales_inventory.sales_inventory_thermatru )
...
, FILTER_A as (
    SELECT *
    FROM RENAME_A
    WHERE rec_src = 'US.API_FT.LOWES_VPP.SALES_INVENTORY_THERMATRU'
)

...
, LOGIC_S as (
    SELECT
      ...
      , 'Master Lock'                                                as                              VENDORCENTRAL_ACCOUNT
      , ASIN
      , CUSTOMER_RETURNS

...
, LOGIC_S as (
    SELECT
      ...
      , 'MASTER LOCK COMPANY LLC / SENTRY SAFE'                      as                              VENDORCENTRAL_ACCOUNT
      , ASIN
      , CUSTOMER_RETURNS

...
, LOGIC_S as (
    SELECT
      ...
      , 'Moen Inc'                                                   as                              VENDORCENTRAL_ACCOUNT
      , ASIN
      , CUSTOMER_RETURNS

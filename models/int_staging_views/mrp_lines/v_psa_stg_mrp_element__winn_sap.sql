...
SRC_a              as ( SELECT * FROM {{ source('sap_ecc_prd', 'z_dd07t') }} as SRC 
                        WHERE DOMNAME = 'DELKZ' -- Filters results to the 'DELKZ' domain. In SAP, this domain typically holds values for the "MRP element indicator"
                        AND DDLANGUAGE = 'E'    -- This 'E' filter ensures that we retrieve the "English descriptions or texts" for the 'DELKZ' domain values.
                      ), 

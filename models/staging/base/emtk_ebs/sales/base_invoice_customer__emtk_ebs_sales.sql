...
, cte_ar_hz_locations as (
    select location_id::varchar as location_id
...
, cte_final as (
    select
        ...
        , hl2.location_id as ship_location_id -- ship-to location
    ...
    from cte_ra_customer_trx_all as rcta
        ...
        /* ship_to joins */
        inner join cte_hz_cust_site_uses_all as hcsu2
            on rcta.ship_to_site_use_id = hcsu2.site_use_id -- ship-to location
        inner join cte_hz_cust_acct_sites_all as hcas2
            on hcsu2.cust_acct_site_id = hcas2.cust_acct_site_id
        inner join cte_ar_hz_party_sites as hps2
            on hcas2.party_site_id = hps2.party_site_id
        inner join cte_ar_hz_locations as hl2
            on hps2.location_id = hl2.location_id -- ship-to location

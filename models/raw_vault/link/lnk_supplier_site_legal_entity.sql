---- SRC LAYER ----
WITH
SRC_SMDM           as ( SELECT LEGAL_ENTITY_HK, LOAD_DTS, REC_SRC, SUPPLIER_HK, SUPPLIER_SITE_HK, SUPPLIER_SITE_LEGAL_ENTITY_HK FROM {{ ref('v_psa_stg_supplier_site_org__mdm') }} as SRC 
                        QUALIFY (ROW_NUMBER() OVER(PARTITION BY SUPPLIER_SITE_LEGAL_ENTITY_HK ORDER BY LOAD_DTS ))=1 )

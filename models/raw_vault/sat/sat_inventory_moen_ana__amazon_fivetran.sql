---- SRC LAYER ----
WITH
SRC_SSA            as ( SELECT * FROM {{ ref('v_psa_stg_inventory_moen_ana__amazon_fivetran') }} as SRC 
                         {% if is_incremental() %}
                         WHERE SRC.LOAD_DTS > (SELECT DATEADD('HOUR', '-1', MAX(LOAD_DTS)) FROM {{this}})
                         {% endif %}  )

/*
SRC_SSA            as ( SELECT * FROM STAGING.v_psa_stg_inventory_moen_ana__amazon_fivetran )
*/
---- LOGIC LAYER ----

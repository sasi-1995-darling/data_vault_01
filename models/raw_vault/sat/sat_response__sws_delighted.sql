---- SRC LAYER ----
WITH
SRC_S1             as ( SELECT * FROM {{ ref('v_psa_stg_response__sws_delighted') }} as SRC 
                         {% if is_incremental() %}
                         WHERE SRC.LOAD_DTS > (SELECT DATEADD('HOUR', '-1', MAX(LOAD_DTS)) FROM {{this}})
                         {% endif %}  )

/*
SRC_S1             as ( SELECT * FROM staging.v_psa_stg_response__sws_delighted )
*/
---- LOGIC LAYER ----
...
SELECT 
  ...
  , null as PROPERTIES_DELIGHTED_LINK_NAME
  , null as PSA_LOAD_DTS
  , null as PSA_RECORD_SOURCE
  , null as PROPERTIES_UTM_CAMPAIGN
  , null as PROPERTIES_UTM_MEDIUM
  , null as PROPERTIES_UTM_SOURCE
  , null as PROPERTIES_UTM_CONTENT
  , null as PROPERTIES_UTM_TERM
  , null as PROPERTIES_SAP_OUTBOUND_ID
  , null as PSA_DELETE_IND
  , 'US.DELIGHTED_SWS.RESPONSE' AS REC_SRC

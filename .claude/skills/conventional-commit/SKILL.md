...
5. After generating your commit message, run the following command in your integrated terminal to commit:
...
- Commit generated model files without approval
- Use a generic commit message without the conventional prefix
